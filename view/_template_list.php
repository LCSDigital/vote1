...
<html  xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="<?php echo APP_DIR; ?>css/app.css"/>
		<script>
	...
	<body class="<?php echo $tpl['page']; ?>">
		...
		<div class="navigation">
			...
			<!-- champs recherche -->
			<div class="rechercher navigation-item">
				<form id="form_to_search" >
						<input type="text" id="search" name="search" class="search"  autocomplete="off" value="<?php echo $request_data['search']; ?>" placeholder="Ville / Nom du club" />
		...
		<script src="<?php echo APP_DIR; ?>js/app.js"></script>
